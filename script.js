const cuestionarios = {
	...
	html: {
		...
		preguntas: [
			...
			{pregunta: "¿Cuál es la etiqueta correcta para insertar una imagen?",opciones: ["<img>", "<image>", "<pic>", "<source>"],respuesta: 0,},
			{pregunta: "¿Qué atributo se usa para especificar la URL de un enlace?",opciones: ["href", "src", "link", "url"],respuesta: 0,},
			{pregunta: "¿Para qué se usa la etiqueta <div>?",opciones: ["Crear un contenedor de bloque","Insertar texto en negrita","Agregar comentarios","Mostrar imágenes",],respuesta: 0,},
			{pregunta:"¿Cuál es la forma correcta de cerrar una etiqueta autocontenida como <img>?",opciones: ["No necesita cerrarse", "</img>", "<img/>", "<img>"],respuesta: 0,},
			{pregunta: "¿Qué etiqueta se usa para definir una lista desordenada?",opciones: ["<ul>", "<ol>", "<li>", "<list>"],respuesta: 0,},
			{pregunta: "¿Cuál de estos elementos crea un salto de línea?",opciones: ["<br>", "<lb>", "<hr>", "<break>"],respuesta: 0,},
			{pregunta:"¿Qué elemento define información de contacto en el pie de página?",opciones: ["<address>", "<contact>", "<footer>", "<info>"],respuesta: 0,},
			{pregunta:"¿Qué atributo se usa para asociar un label con un input a través de su id?",opciones: ["for", "id", "label", "input-id"],respuesta: 0,},
			{pregunta:"¿Cuál es la etiqueta correcta para resaltar texto importante?",opciones: ["<strong>", "<bold>", "<highlight>", "<em>"],respuesta: 0,},
		],
	},
	...
	css: {
		...
		preguntas: [
			...
			{pregunta: "¿Cómo se selecciona un elemento por su ID en CSS?",opciones: ["#id", ".id", "id", "*id"],respuesta: 0,},
			{pregunta: "¿Cuál de estos NO es un tipo de selector en CSS?",opciones: [".clase", "#id", "@media", "/element"],respuesta: 3,},
			{pregunta: "¿Para qué se usa la propiedad display: flex;?",opciones: ["Para crear un contenedor flexible","Para centrar elementos verticalmente","Para activar el modo diseño responsivo","Para ocultar elementos",],respuesta: 0,},
			{pregunta:"¿Cuál propiedad controla el espacio entre el contenido y el borde de un elemento?",opciones: ["padding", "margin", "border", "spacing"],respuesta: 0,},
			{pregunta:"¿Qué valor de position mantiene el elemento en relación a la ventana del navegador?",opciones: ["fixed", "absolute", "relative", "sticky"],respuesta: 0,},
			{pregunta:"¿Qué unidad CSS se basa en el tamaño de fuente del elemento raíz?",opciones: ["rem", "em", "%", "px"],respuesta: 0,},
			{pregunta: "¿Qué propiedad se usa para aplicar sombras a textos?",opciones: ["text-shadow", "box-shadow", "shadow-text", "font-shadow"],respuesta: 0,},
			{pregunta:"¿Cuál es la sintaxis correcta para importar una hoja de estilo CSS?",opciones: ["@import 'estilo.css';","import 'estilo.css';","<link rel='stylesheet' href='estilo.css'>","Todas son correctas",],respuesta: 0,},
			{pregunta: "¿Qué hace la propiedad z-index?",opciones: ["Controla el orden de apilamiento de elementos","Ajusta el tamaño de los elementos","Cambia el color de fondo","Establece el tiempo de transición",],respuesta: 0,},
		],
	},
	//10 preguntas de la opcion de JavaScript
	js: {
		nombre: "JavaScript",
		preguntas: [
...
function mostrarPregunta() {
	...
	const opcionesOriginales = pregunta.opciones.map((texto, indice) => ({texto,esCorrecta: indice === pregunta.respuesta}));
